namespace DirectX.D3D11.DeviceContextStages
{
	...
	*/
	public struct DomainShaderStage : ID3D11DeviceContext
	{
		/**
		...
		*/
		public void SetShader(ID3D11DomainShader *pDomainShader, ID3D11ClassInstance **ppClassInstances, UINT numClassInstances) mut
		{
