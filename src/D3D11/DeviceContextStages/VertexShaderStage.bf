namespace DirectX.D3D11.DeviceContextStages
{
	...
	*/
	public struct VertexShaderStage : ID3D11DeviceContext
	{
		/**
		...
		*/
		public void SetShader(ID3D11VertexShader *pVertexShader, ID3D11ClassInstance **ppClassInstances, UINT numClassInstances) mut
		{
