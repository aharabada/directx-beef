...
namespace DirectX.D3D11
{
	...
	*/
	public struct ID3D11DeviceContext : ID3D11DeviceChild, IComObject
	{
		...
		{
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, uint32 startSlot, uint32 numBuffers, ID3D11Buffer** ppConstantBuffers) VSSetConstantBuffers;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, uint32 startSlot, uint32 numViews, ID3D11ShaderResourceView** ppShaderResourceViews) PSSetShaderResources;

			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11PixelShader* pPixelShader, ID3D11ClassInstance** ppClassInstance, uint32 numClassInstances) PSSetShader;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, uint32 startSlot, uint32 numSamplers, ID3D11SamplerState** ppSamplers) PSSetSamplers; 
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11VertexShader* pVertexShader, ID3D11ClassInstance** ppClassInstance, uint32 numClassInstances) VSSetShader;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT indexCount, UINT startIndexLocation, INT baseVertexLocation) DrawIndexed;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT vertexCount, UINT startVertexLocation) Draw;

			public function [CallingConvention(.Stdcall)] HResult(ID3D11DeviceContext* self, ID3D11Resource* pResource, UINT subresource, MapType mapType, D3D11.MapFlags, MappedSubresource* pMappedResource) Map;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11Resource* pResource, uint32 subresource) Unmap;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, uint32 startSlot, uint32 numBuffers, ID3D11Buffer** ppConstantBuffers) PSSetConstantBuffers;

			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11InputLayout *pInputLayout) IASetInputLayout;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numBuffers, ID3D11Buffer** ppVertexBuffers, UINT* pStride, UINT* pOffset) IASetVertexBuffers;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11Buffer* ppIndexBuffers, Format format, UINT offset) IASetIndexBuffer;

			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT indexCountPerInstance, UINT instanceCount, UINT startIndexLocation, INT baseVertexLocation, UINT startInstanceLocation) DrawIndexedInstanced;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT vertexCountPerInstance, UINT instanceCount, UINT startVertexLocation, UINT startInstanceLocation) DrawInstanced;

			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numBuffers, ID3D11Buffer **ppConstantBuffers) GSSetConstantBuffers;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11GeometryShader *pComputeShader, ID3D11ClassInstance **ppClassInstances, UINT numClassInstances) GSSetShader; 
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, PrimitiveTopology primitiveTopology) IASetPrimitiveTopology;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numViews, ID3D11ShaderResourceView **ppShaderResourceViews) VSSetShaderResources;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numBuffers, ID3D11SamplerState **ppSamplers) VSSetSamplers;

			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11Asynchronous *pAsync) Begin;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11Asynchronous *pAsync) End;

			public function [CallingConvention(.Stdcall)] HResult(ID3D11DeviceContext* self, ID3D11Asynchronous *pAsync,	void *pData, UINT dataSize, AsyncGetDataFlags getDataFlags) GetData;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11Predicate *pPredicate, BOOL predicateValue) SetPredication;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numViews, ID3D11ShaderResourceView **ppShaderResourceViews) GSSetShaderResources;  
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numBuffers, ID3D11SamplerState **ppSamplers) GSSetSamplers;

			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT numViews, ID3D11RenderTargetView **ppRenderTargetViews, ID3D11DepthStencilView *pDepthStencilView) OMSetRenderTargets;
			...
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self) DrawAuto;

			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11Buffer *pBufferForArgs, UINT alignedByteOffsetForArgs) DrawIndexedInstancedIndirect; 
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11Buffer *pBufferForArgs, UINT alignedByteOffsetForArgs) DrawInstancedIndirect;

			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT threadGroupCountX, UINT threadGroupCountY, UINT threadGroupCountZ) Dispatch;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11Buffer *pBufferForArgs, UINT alignedByteOffsetForArgs) DispatchIndirect;

			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11RasterizerState *pRasterizerState) RSSetState;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT numViewports, Viewport* pViewports) RSSetViewports;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT numRects, Rectangle *pRects) RSSetScissorRects;

			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11Resource *pDstResource,uint32 DstSubresource, uint32 DstX, uint32 DstY, uint32 DstZ, ID3D11Resource  *pSrcResource, uint32 SrcSubresource, Box *pSrcBox) CopySubresourceRegion;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11Resource* pDstResource, ID3D11Resource* pSrcResource) CopyResource;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11Resource* pDstResource, uint32 dstSubresource, Box* pDstBox, void* pSrcData, uint32 srcRowPitch, uint32 srcDepthPitch) UpdateSubresource;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11Buffer *pDstBuffer, uint32 dstAlignedByteOffset, ID3D11UnorderedAccessView *pSrcView) CopyStructureCount;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11RenderTargetView* pRenderTargetView, ColorRGBA colorRGBA) ClearRenderTargetView;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11UnorderedAccessView* pUnorderedAccessView, uint32[4] values) ClearUnorderedAccessViewUint;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11UnorderedAccessView* pUnorderedAccessView, ColorRGBA colorRGBA) ClearUnorderedAccessViewFloat;

			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11DepthStencilView* pDepthStencilView, ClearFlag clearFlags, float Depth, uint8 Stencil) ClearDepthStencilView;
			
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11ShaderResourceView *pShaderResourceView) GenerateMips; 
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11Resource *pResource, float MinLOD) SetResourceMinLOD;
			public function [CallingConvention(.Stdcall)] float(ID3D11DeviceContext* self, ID3D11Resource *pResource) GetResourceMinLOD;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11Resource *pDstResource, UINT dstSubresource, ID3D11Resource *pSrcResource, UINT srcSubresource, Format format) ResolveSubresource;

			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11CommandList *pCommandList, BOOL restoreContextState) ExecuteCommandList;

			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numViews, ID3D11ShaderResourceView **ppShaderResourceViews) HSSetShaderResources;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11HullShader *pComputeShader, ID3D11ClassInstance **ppClassInstances, UINT numClassInstances) HSSetShader;   
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numBuffers, ID3D11SamplerState **ppSamplers) HSSetSamplers;   
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numBuffers, ID3D11Buffer **ppConstantBuffers) HSSetConstantBuffers;
  
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numViews, ID3D11ShaderResourceView **ppShaderResourceViews) DSSetShaderResources;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11DomainShader *pComputeShader, ID3D11ClassInstance **ppClassInstances, UINT numClassInstances) DSSetShader;   
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numBuffers, ID3D11SamplerState **ppSamplers) DSSetSamplers;   
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numBuffers, ID3D11Buffer **ppConstantBuffers) DSSetConstantBuffers;
  
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numViews, ID3D11ShaderResourceView **ppShaderResourceViews) CSSetShaderResources;  
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numUAVs, ID3D11UnorderedAccessView **ppUnorderedAccessViews, UINT *pUAVInitialCounts) CSSetUnorderedAccessViews; 
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11ComputeShader *pComputeShader, ID3D11ClassInstance **ppClassInstances, UINT numClassInstances) CSSetShader;   
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numBuffers, ID3D11SamplerState **ppSamplers) CSSetSamplers;   
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numBuffers, ID3D11Buffer **ppConstantBuffers) CSSetConstantBuffers;
  
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numBuffers, ID3D11Buffer **ppConstantBuffers) VSGetConstantBuffers;   
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numViews, ID3D11ShaderResourceView **ppShaderResourceViews) PSGetShaderResources;    
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11PixelShader **ppPixelShader, ID3D11ClassInstance **ppClassInstances, UINT *pNumClassInstances) PSGetShader;    
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numSamplers, ID3D11SamplerState **ppSamplers) PSGetSamplers;    
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11VertexShader **ppVertexShader, ID3D11ClassInstance **ppClassInstances, UINT *pNumClassInstances) VSGetShader;    
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numBuffers, ID3D11Buffer **ppConstantBuffers) PSGetConstantBuffers;
    
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11InputLayout **ppInputLayout) IAGetInputLayout;    
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numBuffers, ID3D11Buffer **ppVertexBuffers, UINT *pStrides, UINT *pOffsets) IAGetVertexBuffers;    
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11Buffer **pIndexBuffer, Format *format, UINT *offset) IAGetIndexBuffer;
   
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numBuffers, ID3D11Buffer **ppConstantBuffers) GSGetConstantBuffers; 
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11GeometryShader **ppComputeShader, ID3D11ClassInstance **ppClassInstances, uint32 *pNumClassInstances) GSGetShader;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, PrimitiveTopology *pTopology) IAGetPrimitiveTopology;    
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numViews, ID3D11ShaderResourceView **ppShaderResourceViews) VSGetShaderResources;    
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numSamplers, ID3D11SamplerState **ppSamplers) VSGetSamplers;
 
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11Predicate **ppPredicate, BOOL *pPredicateValue) GetPredication;
      
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numViews, ID3D11ShaderResourceView **ppShaderResourceViews) GSGetShaderResources;   
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numSamplers, ID3D11SamplerState **ppSamplers) GSGetSamplers;
     
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT numViews, ID3D11RenderTargetView **ppRenderTargetViews, ID3D11DepthStencilView **ppDepthStencilView) OMGetRenderTargets;
     
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT numRTVs, ID3D11RenderTargetView **ppRenderTargetViews, ID3D11DepthStencilView **ppDepthStencilView,
			...
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11BlendState **ppBlendState, ColorRGBA *pBlendFactor, UINT *pSampleMask) OMGetBlendState;      
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11DepthStencilState **ppDepthStencilState, UINT *pStencilRef) OMGetDepthStencilState;
      
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT numBuffers, ID3D11Buffer **ppSOTargets) SOGetTargets;
      
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11RasterizerState **ppRasterizerState) RSGetState;      
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT *pNumViewports, Viewport *pViewports) RSGetViewports; 
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT *pNumRects, Rectangle *pRects) RSGetScissorRects;
   
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numViews, ID3D11ShaderResourceView **ppShaderResourceViews) HSGetShaderResources;   
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11HullShader **ppComputeShader, ID3D11ClassInstance **ppClassInstances, uint32 *pNumClassInstances) HSGetShader;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numSamplers, ID3D11SamplerState **ppSamplers) HSGetSamplers;   
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numBuffers, ID3D11Buffer **ppConstantBuffers) HSGetConstantBuffers;
  
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numViews, ID3D11ShaderResourceView **ppShaderResourceViews) DSGetShaderResources;   
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11DomainShader **ppComputeShader, ID3D11ClassInstance **ppClassInstances, uint32 *pNumClassInstances) DSGetShader;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numSamplers, ID3D11SamplerState **ppSamplers) DSGetSamplers;   
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numBuffers, ID3D11Buffer **ppConstantBuffers) DSGetConstantBuffers;

			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numViews, ID3D11ShaderResourceView **ppShaderResourceViews) CSGetShaderResources;   
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numUAVs, ID3D11UnorderedAccessView **ppUnorderedAccessViews) CSGetUnorderedAccessViews;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, ID3D11ComputeShader **ppComputeShader, ID3D11ClassInstance **ppClassInstances, uint32 *pNumClassInstances) CSGetShader;
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numSamplers, ID3D11SamplerState **ppSamplers) CSGetSamplers;   
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self, UINT startSlot, UINT numBuffers, ID3D11Buffer **ppConstantBuffers) CSGetConstantBuffers;
   
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self) ClearState;   
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self) Flush;
			public function [CallingConvention(.Stdcall)] DeviceContextType(ID3D11DeviceContext* self) GetDeviceContextType;     
			public function [CallingConvention(.Stdcall)] void(ID3D11DeviceContext* self) GetContextFlags;   

			public function [CallingConvention(.Stdcall)] HResult(ID3D11DeviceContext* self, BOOL restoreDeferredContextState, ID3D11CommandList **ppCommandList) FinishCommandList;              
		}
